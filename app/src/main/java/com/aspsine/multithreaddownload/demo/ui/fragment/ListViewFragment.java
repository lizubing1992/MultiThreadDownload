...
import com.aspsine.multithreaddownload.demo.ui.adapter.ListViewAdapter.ViewHolder;
    ...
    for (AppInfo info : mAppInfos) {
      ...
      if (downloadInfo != null) {
        ...
        info.setDownloadPerSize(
            Utils.getDownloadPerSize(downloadInfo.getFinished(), downloadInfo.getLength()));
